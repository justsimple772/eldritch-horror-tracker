...
const PRECACHE=["./","./index.html","./manifest.webmanifest","./mobile-ui.css?v=20260920-c","./icon-192.png","./icon-512.png","./apple-touch-icon.png"].concat(PORTRAITS);
