...
const PRECACHE=["./","./index.html","./manifest.webmanifest","./mobile-ui.css?v=20260926-b","./icon-192.png","./icon-512.png","./apple-touch-icon.png"].concat(PORTRAITS);
